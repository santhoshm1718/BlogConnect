    ...
    if(isset($_GET['prof_id'])) {
        ...
        if(isset($_POST['submit'])) {
            if($_POST['email'] == '' OR $_POST['username'] == '') {
                ...
                header('location: http://localhost/BlogConnect/users/profile.php?prof_id='.$_SESSION['user_id'].'');
            }
...
?>
            ...
            <form method="POST" action="profile.php?prof_id=<?php echo $rows->id; ?>" enctype="multipart/form-data">
              ...
              <div class="form-outline mb-4">
                <input type="text" name="username" value="<?php echo $rows->user_name; ?>" id="form2Example1" class="form-control" placeholder="username" />
            </div>
